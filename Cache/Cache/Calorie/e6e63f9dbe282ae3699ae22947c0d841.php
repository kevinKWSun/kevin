...
function choose_foodsy(d){
	$('.choose_foods_'+d).css('color','red');
				...
				<a href="javascript:void(0);" onclick="choose_foods(9);" class="choose_foods_9">运动健身</a>			'; }else if($_GET['idc']=='7'){ echo '<font color="red" style="width:300px; float:left;">零食 / 点心</font>'; }else{ echo '
