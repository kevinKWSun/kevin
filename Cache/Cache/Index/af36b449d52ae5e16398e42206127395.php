<?php if (!defined('THINK_PATH')) exit();?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8" /><title>身体质量指数,<?php echo (C("WEB_NAME")); ?></title><meta name="keywords" content="身体质量指数,健康体重范围,bmi" /><meta name="description" content="不同于标准体重，它是一个范围值，其原理是通过BMI身体质量指数反向推算。健康范围的身体质量指数(BMI)在18.5到24之间，结合身高，就可以计算出健康体重范围..." /><link href="__PUBLIC__/Slim/Css/sunny.css" rel="stylesheet" media="screen" type="text/css" /><script src="__PUBLIC__/Js/iepng.js" type="text/javascript"></script><script src="__PUBLIC__/Js/jquery-1.7.2.min.js" type="text/javascript"></script><script>$(function(){
	$( '.submit' ).click( function () {
		...
		return false;
				...
				<a href="<?php echo U('/list-' . '23');?>" title="健康瘦身餐" style="letter-spacing:4px;">瘦身餐</a></div></div></div></div><div class="g970"><?php echo (C("g97090")); ?></div><div id="main"><div class="location border_bottom"><a href="<?php echo (C("WEB_ADDRESS")); ?>">诗诗瘦身网</a> >> 健康体重范围</div><div id="list_left"><p class="guidetitle"><span>健康体重范围</span></p><div class="guidecont hwr"><p><span class="stress">健康体重</span>不同于标准体重，它是一个范围值，其原理是通过BMI身体质量指数反向推算。健康范围的身体质量指数(BMI)在18.5到24之间，结合身高，就可以计算出健康体重范围。</p></div><div class="divs"><p class="fonts">请输入您的身高：</p><p class="clear">　
