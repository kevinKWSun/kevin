...
<title><?php echo ($typename["name"]); ?>,<?php echo (C("WEB_NAME")); ?></title>
<meta name="keywords" content="<?php echo ($typename["name"]); ?>,<?php echo (C("WEB_KEYWORD")); ?>" />
<meta name="description" content="<?php echo ($typename["name"]); ?>,<?php echo (C("WEB_DESCRIPTION")); ?>..." />
...
<div id="main">
	<div class="location border_bottom"><a href="<?php echo (C("WEB_ADDRESS")); ?>">诗诗瘦身网</a> >> <?php echo ($typename["name"]); ?></div> 
	<div id="list_left">
		<h1 class="guidetitle"><?php echo ($typename["name"]); ?>列表</h1>
		<?php if(is_array($news)): foreach($news as $key=>$v): ?><dl>
