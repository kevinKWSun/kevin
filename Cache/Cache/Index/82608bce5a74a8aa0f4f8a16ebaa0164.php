...
<div id="main">
	<div class="location border_bottom"><a href="<?php echo (C("WEB_ADDRESS")); ?>">诗诗瘦身网</a> >> 搜索 '<?php echo ($keyword); ?>' 的结果</div> 
	<div id="list_left">
		...
		<?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "$emptys" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><dl>
				<dt><a href="<?php echo U('/' . $v['id']);?>"><img src="<?php echo ($v["images"]); ?>" width="100" height="115" alt="<?php echo ($v["title"]); ?>" /></a></dt>
				<dd>
					<strong class="clear"><a href="<?php echo U('/' . $v['id']);?>"><?php echo ($v["title"]); ?></a></strong>
					<div class="info"><?php echo (subtext($v["description"],80)); ?>...</div>
					<div class="clear">
						<font>时间：<?php echo (date('m月d日 H:i:s',$v["stime"])); ?></font>　　
						<font>关注：<?php echo ($v["click"]); ?></font>　　
						<font><a href="<?php echo U('/' . $v['id']);?>">查看全文>></a></font>
					</div>
				</dd>
