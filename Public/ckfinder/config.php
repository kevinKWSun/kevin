...
*/
$baseUrl =dirname(dirname(dirname(dirname(dirname(dirname($_SERVER['PHP_SELF'])))))).'/Uploads/';
...
$config['ResourceType'][] = Array(
		'name' => 'Common Images',
		'url' => $baseUrl . 'images',
		'directory' => $baseDir . 'image/images',
		'maxSize' => 0,
