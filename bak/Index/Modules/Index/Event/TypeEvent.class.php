...
class TypeEvent{
	...
	public function qq($token){
		$qq   = SunyOauth::getInstance('qq', $token);
	...
	public function tencent($token){
		$tencent = SunyOauth::getInstance('tencent', $token);
	...
	public function sina($token){
		$sina = SunyOauth::getInstance('sina', $token);
	...
	public function t163($token){
		$t163 = SunyOauth::getInstance('t163', $token);
	...
	public function renren($token){
		$renren = SunyOauth::getInstance('renren', $token);
	...
	public function x360($token){
		$x360 = SunyOauth::getInstance('x360', $token);
	...
	public function douban($token){
		$douban = SunyOauth::getInstance('douban', $token);
	...
	public function github($token){
		$github = SunyOauth::getInstance('github', $token);
	...
	public function google($token){
		$google = SunyOauth::getInstance('google', $token);
	...
	public function msn($token){
		$msn  = SunyOauth::getInstance('msn', $token);
		$data = $msn->call('me');
	...
	public function diandian($token){
		$diandian  = SunyOauth::getInstance('diandian', $token);
	...
	public function taobao($token){
		$taobao = SunyOauth::getInstance('taobao', $token);
	...
	public function baidu($token){
		$baidu = SunyOauth::getInstance('baidu', $token);
	...
	public function kaixin($token){
		$kaixin = SunyOauth::getInstance('kaixin', $token);
	...
	public function sohu($token){
		$sohu = SunyOauth::getInstance('sohu', $token);
