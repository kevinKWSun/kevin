...
class Pagesearch {
     ...
     */
    public function __construct($totalRows,$listRows='',$isShort=0,$parameter='',$url='') {
        $this->totalRows    =   $totalRows;
        $this->parameter    =   $parameter;
        $this->varPage      =   C('VAR_PAGE') ? C('VAR_PAGE') : 'p' ;
        $this->asgin        =   C('URL_ASGIN') ? C('URL_ASGIN') : 'search' ;
        $this->split        =   C('URL_SPLIT') ? C('URL_SPLIT') : '/' ;
    ...
    public function show() {
        ...
        if($this->url){
            ...
            $url   = $this->isShort ? U('/*%'.$parameter[title].'%'.$parameter['p']) : U('',$parameter);
